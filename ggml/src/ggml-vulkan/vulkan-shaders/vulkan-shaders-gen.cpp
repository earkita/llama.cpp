...
void process_shaders() {
    ...
    string_to_spv("lightning_indexer_top_k_f32", "lightning_indexer_top_k.comp", {{"K_TYPE", "float"}, {"CANDIDATE_TILE", "0"}});
    string_to_spv("lightning_indexer_top_k_f32_candidate_tile", "lightning_indexer_top_k.comp", {{"K_TYPE", "float"}, {"CANDIDATE_TILE", "1"}});
    string_to_spv("lightning_indexer_top_k_f16", "lightning_indexer_top_k.comp", {{"K_TYPE", "float16_t"}, {"CANDIDATE_TILE", "0"}});
    string_to_spv("lightning_indexer_top_k_f16_candidate_tile", "lightning_indexer_top_k.comp", {{"K_TYPE", "float16_t"}, {"CANDIDATE_TILE", "1"}});
