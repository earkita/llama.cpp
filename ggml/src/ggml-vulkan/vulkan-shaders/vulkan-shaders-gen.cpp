...
void process_shaders() {
    ...
    string_to_spv("lightning_indexer_f32",  "lightning_indexer.comp", {{"DATA_A_F32", "1"}});
    string_to_spv("lightning_indexer_f16",  "lightning_indexer.comp", {{"DATA_A_F16", "1"}});
    string_to_spv("lightning_indexer_q4_0", "lightning_indexer.comp", {{"DATA_A_Q4_0", "1"}});
    string_to_spv("lightning_indexer_q4_1", "lightning_indexer.comp", {{"DATA_A_Q4_1", "1"}});
